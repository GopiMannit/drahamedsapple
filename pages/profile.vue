...
export default {
  ...
  computed: {
    eyeIconClassoldPassword() {
      return this.showoldPassword ? 'fas fa-eye' : 'fas fa-eye-slash';
    },
    eyeIconClassnewPassword() {
      return this.shownewPassword ? 'fas fa-eye' : 'fas fa-eye-slash';
    },
    eyeIconClassconfirmPassword() {
      return this.showconfirmPassword ? 'fas fa-eye' : 'fas fa-eye-slash';
    },
