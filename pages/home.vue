  ...
  <div class="page">
    ...
    <div class="full">
      <div class="grid-container">
        <div class="grid-item">
          <svg @click="goToRoute('/patient')" width="50" height="50" viewBox="0 0 26 25" fill="none"
            xmlns="http://www.w3.org/2000/svg">

            <ellipse cx="12.7432" cy="12.5" rx="12.7432" ry="12.5" fill="#8DB600" />
        ...
        <div class="grid-item">
          <svg width="50" height="50" viewBox="0 0 25 25" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <circle cx="12.5" cy="12.5" r="12.5" fill="#8DB600" @click="goToRoute()" />
            <path
        ...
        <div class="grid-item">
          <svg width="50" height="50" viewBox="0 0 90 91" xmlns="http://www.w3.org/2000/svg" @click="goToRoute()">
...
export default {
  ...
  mounted() {
    ...
    if (storedUser) {
      ...
      console.log(this.user.loggedInUser.role);
